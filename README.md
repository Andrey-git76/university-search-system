...
| Роль | Имя | Вклад |
| :--- | :--- | :--- |
| **Backend-инженер** | Андрей Тимохин | Разработка API, интеграция с Elasticsearch, бизнес-логика, работа с БД |
| **Frontend-инженер** | Курбан Гасанов | Разработка интерфейса, верстка, клиент-серверное взаимодействие |
| **DevOps-инженер** | Егор Гутник | Контейнеризация, CI/CD, мониторинг, управление окружением |
| **QA-инженер** | Роман Журавлёв | Автоматизация тестирования, подготовка данных, контроль качества, документация |
---
